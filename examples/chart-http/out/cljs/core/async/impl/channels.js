...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t13989 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t13989 = (function (val,box,meta13990){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t13989.cljs$lang$type = true;
cljs.core.async.impl.channels.t13989.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t13989";
cljs.core.async.impl.channels.t13989.cljs$lang$ctorPrWriter = (function (this__4108__auto__,writer__4109__auto__,opt__4110__auto__){return cljs.core._write.call(null,writer__4109__auto__,"cljs.core.async.impl.channels/t13989");
});
cljs.core.async.impl.channels.t13989.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t13989.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_13991){var self__ = this;
var _13991__$1 = this;return self__.meta13990;
});
cljs.core.async.impl.channels.t13989.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_13991,meta13990__$1){var self__ = this;
var _13991__$1 = this;return (new cljs.core.async.impl.channels.t13989(self__.val,self__.box,meta13990__$1));
});
cljs.core.async.impl.channels.__GT_t13989 = (function __GT_t13989(val__$1,box__$1,meta13990){return (new cljs.core.async.impl.channels.t13989(val__$1,box__$1,meta13990));
});
}
return (new cljs.core.async.impl.channels.t13989(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_13992 = self__.takes.pop();if((taker_13992 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_13992))
{var take_cb_13993 = cljs.core.async.impl.protocols.commit.call(null,taker_13992);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_13993,taker_13992,this$__$1){
return (function (){return take_cb_13993.call(null,null);
});})(take_cb_13993,taker_13992,this$__$1))
);
} else
{}
{
