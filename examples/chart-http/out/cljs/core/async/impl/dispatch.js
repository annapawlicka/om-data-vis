...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_13983 = 0;while(true){
var m_13984 = cljs.core.async.impl.dispatch.tasks.pop();if((m_13984 == null))
{} else
{m_13984.call(null);
if((count_13983 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__13985 = (count_13983 + 1);
count_13983 = G__13985;
continue;
}
} else
{}
