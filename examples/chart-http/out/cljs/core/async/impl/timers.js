...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_13948 = 0;while(true){
if((i_13948 < arr.length))
{(arr[i_13948] = null);
{
var G__13949 = (i_13948 + 1);
i_13948 = G__13949;
continue;
}
} else
...
{var i_13955 = (self__.level + 1);while(true){
if((i_13955 <= (new_level + 1)))
{(update[i_13955] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_13957 = 0;while(true){
if((i_13957 <= self__.level))
{var links_13958 = (update[i_13957]).forward;if(((links_13958[i_13957]) === x__$1))
{(links_13958[i_13957] = (x__$1.forward[i_13957]));
{
