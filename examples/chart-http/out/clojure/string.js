...
{{
var G__10814 = cljs.core.pop.call(null,v__$1);
v__$1 = G__10814;
continue;
}
} else
...
{var pred__10818 = cljs.core._EQ_;var expr__10819 = limit;if(cljs.core.truth_(pred__10818.call(null,1,expr__10819)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__10818.call(null,2,expr__10819)))
...
var G__10821 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__10822 = (limit__$1 - 1);
var G__10823 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__10821;
limit__$1 = G__10822;
parts = G__10823;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___10825 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___10825))
{var replacement_10826 = temp__4090__auto___10825;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_10826)));
} else
{buffer.append(ch);
}
{
var G__10827 = (index + 1);
index = G__10827;
continue;
}
}
