...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t14666 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t14666 = (function (val,box,meta14667){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t14666.cljs$lang$type = true;
cljs.core.async.impl.channels.t14666.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t14666";
cljs.core.async.impl.channels.t14666.cljs$lang$ctorPrWriter = (function (this__4124__auto__,writer__4125__auto__,opt__4126__auto__){return cljs.core._write.call(null,writer__4125__auto__,"cljs.core.async.impl.channels/t14666");
});
cljs.core.async.impl.channels.t14666.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t14666.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_14668){var self__ = this;
var _14668__$1 = this;return self__.meta14667;
});
cljs.core.async.impl.channels.t14666.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_14668,meta14667__$1){var self__ = this;
var _14668__$1 = this;return (new cljs.core.async.impl.channels.t14666(self__.val,self__.box,meta14667__$1));
});
cljs.core.async.impl.channels.__GT_t14666 = (function __GT_t14666(val__$1,box__$1,meta14667){return (new cljs.core.async.impl.channels.t14666(val__$1,box__$1,meta14667));
});
}
return (new cljs.core.async.impl.channels.t14666(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_14669 = self__.takes.pop();if((taker_14669 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_14669))
{var take_cb_14670 = cljs.core.async.impl.protocols.commit.call(null,taker_14669);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_14670,taker_14669,this$__$1){
return (function (){return take_cb_14670.call(null,null);
});})(take_cb_14670,taker_14669,this$__$1))
);
} else
{}
{
