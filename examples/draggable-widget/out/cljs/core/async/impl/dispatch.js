...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_14660 = 0;while(true){
var m_14661 = cljs.core.async.impl.dispatch.tasks.pop();if((m_14661 == null))
{} else
{m_14661.call(null);
if((count_14660 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__14662 = (count_14660 + 1);
count_14660 = G__14662;
continue;
}
} else
{}
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__3545__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__3545__auto__)
