...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_14567 = 0;while(true){
if((i_14567 < arr.length))
{(arr[i_14567] = null);
{
...
{var i_14574 = (self__.level + 1);while(true){
if((i_14574 <= (new_level + 1)))
{(update[i_14574] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_14576 = 0;while(true){
if((i_14576 <= self__.level))
{var links_14577 = (update[i_14576]).forward;if(((links_14577[i_14576]) === x__$1))
{(links_14577[i_14576] = (x__$1.forward[i_14576]));
{
var G__14578 = (i_14576 + 1);
i_14576 = G__14578;
continue;
}
} else
{{
var G__14579 = (i_14576 + 1);
i_14576 = G__14579;
continue;
}
}
