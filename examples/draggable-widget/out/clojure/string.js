...
{{
var G__10945 = cljs.core.pop.call(null,v__$1);
v__$1 = G__10945;
continue;
}
} else
...
{var pred__10949 = cljs.core._EQ_;var expr__10950 = limit;if(cljs.core.truth_(pred__10949.call(null,1,expr__10950)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__10949.call(null,2,expr__10950)))
...
var G__10952 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__10953 = (limit__$1 - 1);
var G__10954 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__10952;
limit__$1 = G__10953;
parts = G__10954;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___10956 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___10956))
{var replacement_10957 = temp__4124__auto___10956;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_10957)));
} else
{buffer.append(ch);
}
{
var G__10958 = (index + 1);
index = G__10958;
continue;
}
}
