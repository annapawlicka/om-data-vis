...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t13949 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t13949 = (function (val,box,meta13950){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t13949.cljs$lang$type = true;
cljs.core.async.impl.channels.t13949.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t13949";
cljs.core.async.impl.channels.t13949.cljs$lang$ctorPrWriter = (function (this__4124__auto__,writer__4125__auto__,opt__4126__auto__){return cljs.core._write.call(null,writer__4125__auto__,"cljs.core.async.impl.channels/t13949");
});
cljs.core.async.impl.channels.t13949.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t13949.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_13951){var self__ = this;
var _13951__$1 = this;return self__.meta13950;
});
cljs.core.async.impl.channels.t13949.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_13951,meta13950__$1){var self__ = this;
var _13951__$1 = this;return (new cljs.core.async.impl.channels.t13949(self__.val,self__.box,meta13950__$1));
});
cljs.core.async.impl.channels.__GT_t13949 = (function __GT_t13949(val__$1,box__$1,meta13950){return (new cljs.core.async.impl.channels.t13949(val__$1,box__$1,meta13950));
});
}
return (new cljs.core.async.impl.channels.t13949(val,box,null));
});
...
cljs.core.async.impl.channels.PutBox.cljs$lang$ctorPrWriter = (function (this__4127__auto__,writer__4128__auto__,opts__4129__auto__){return cljs.core._write.call(null,writer__4128__auto__,"cljs.core.async.impl.channels/PutBox");
});
...
cljs.core.async.impl.channels.ManyToManyChannel.cljs$lang$ctorPrWriter = (function (this__4124__auto__,writer__4125__auto__,opt__4126__auto__){return cljs.core._write.call(null,writer__4125__auto__,"cljs.core.async.impl.channels/ManyToManyChannel");
});
...
{self__.closed = true;
while(true){
var taker_13952 = self__.takes.pop();if((taker_13952 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_13952))
{var take_cb_13953 = cljs.core.async.impl.protocols.commit.call(null,taker_13952);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_13953,taker_13952,this$__$1){
return (function (){return take_cb_13953.call(null,null);
});})(take_cb_13953,taker_13952,this$__$1))
);
} else
{}
{
