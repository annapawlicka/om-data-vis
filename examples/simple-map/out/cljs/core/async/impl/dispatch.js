...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_13943 = 0;while(true){
var m_13944 = cljs.core.async.impl.dispatch.tasks.pop();if((m_13944 == null))
{} else
{m_13944.call(null);
if((count_13943 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__13945 = (count_13943 + 1);
count_13943 = G__13945;
continue;
}
} else
{}
