...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_13908 = 0;while(true){
if((i_13908 < arr.length))
{(arr[i_13908] = null);
{
...
{var i_13915 = (self__.level + 1);while(true){
if((i_13915 <= (new_level + 1)))
{(update[i_13915] = self__.header);
{
var G__13916 = (i_13915 + 1);
i_13915 = G__13916;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_13917 = 0;while(true){
if((i_13917 <= self__.level))
{var links_13918 = (update[i_13917]).forward;if(((links_13918[i_13917]) === x__$1))
{(links_13918[i_13917] = (x__$1.forward[i_13917]));
{
var G__13919 = (i_13917 + 1);
i_13917 = G__13919;
continue;
}
} else
{{
var G__13920 = (i_13917 + 1);
i_13917 = G__13920;
continue;
}
}
