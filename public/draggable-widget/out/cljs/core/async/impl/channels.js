...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t34162 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t34162 = (function (val,box,meta34163){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t34162.cljs$lang$type = true;
cljs.core.async.impl.channels.t34162.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t34162";
cljs.core.async.impl.channels.t34162.cljs$lang$ctorPrWriter = (function (this__4124__auto__,writer__4125__auto__,opt__4126__auto__){return cljs.core._write.call(null,writer__4125__auto__,"cljs.core.async.impl.channels/t34162");
});
cljs.core.async.impl.channels.t34162.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t34162.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_34164){var self__ = this;
var _34164__$1 = this;return self__.meta34163;
});
cljs.core.async.impl.channels.t34162.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_34164,meta34163__$1){var self__ = this;
var _34164__$1 = this;return (new cljs.core.async.impl.channels.t34162(self__.val,self__.box,meta34163__$1));
});
cljs.core.async.impl.channels.__GT_t34162 = (function __GT_t34162(val__$1,box__$1,meta34163){return (new cljs.core.async.impl.channels.t34162(val__$1,box__$1,meta34163));
});
}
return (new cljs.core.async.impl.channels.t34162(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_34165 = self__.takes.pop();if((taker_34165 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_34165))
{var take_cb_34166 = cljs.core.async.impl.protocols.commit.call(null,taker_34165);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_34166,taker_34165,this$__$1){
return (function (){return take_cb_34166.call(null,null);
});})(take_cb_34166,taker_34165,this$__$1))
);
} else
{}
{
