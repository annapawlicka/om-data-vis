...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_34156 = 0;while(true){
var m_34157 = cljs.core.async.impl.dispatch.tasks.pop();if((m_34157 == null))
{} else
{m_34157.call(null);
if((count_34156 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__34158 = (count_34156 + 1);
count_34156 = G__34158;
continue;
}
} else
{}
